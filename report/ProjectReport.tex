...
% \begin{figure}[!h]%
%   \centering
%   \subfloat{{\includegraphics[width=0.45\linewidth]{img/header_1.png} }}%
%   \qquad
%   \subfloat{{\includegraphics[width=0.45\linewidth]{img/header_2.png} }}%
%   \qquad
%   \caption{Nagłówek - widok www oraz mobilny}%
% \end{figure}
...
% \begin{figure}[!h]
% 	\begin{center}
% 		\includegraphics[width=0.7\linewidth]{img/welcome_screen.png}
% 	\end{center}
...
% \begin{figure}[!h]
% 	\begin{center}
% 		\includegraphics[width=0.7\linewidth]{img/expense_screen.png}
% 	\end{center}
